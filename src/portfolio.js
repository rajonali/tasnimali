  ...
  schools: [
    {
      ...
      logo: require("./assets/images/subrlogo.png"),
  ...
  experience: [
    {
      ...
      company: "Listed-B",
      companylogo: require("./assets/images/listedblogo.svg"),
    ...
    },
    {
      ...
      companylogo: require("./assets/images/ems.png"),
...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/ListedB.png"),
      projectName: "ListedB",
  ...
  achievementsCards: [
    {
      ...
      image: require("./assets/images/lhsra.jpeg"),
      footerLink: [
        {
          name: "Certification",
